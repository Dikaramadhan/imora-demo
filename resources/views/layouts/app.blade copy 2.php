{{-- 
    CSRF REMINDER:
    - Semua <form method="POST"> wajib pakai @csrf
    - Link wa.me, mailto, tel: tidak perlu CSRF (bukan POST)
    - Jika tambah form RSVP/kontak, gunakan Route::post() + @csrf
--}}
...
<head>
    ...
    <meta name="description"
        content="Imora — Katalog undangan digital elegan & modern untuk pernikahan, khitanan, ulang tahun, dan wisuda. Harga mulai Rp 75.000, pengerjaan cepat 1-2 hari.">
    <meta name="keywords"
    ...
    <meta property="og:description"
        content="Undangan digital elegan & modern. Mulai Rp 75.000, siap dalam 1-2 hari kerja.">
...
<body class="bg-berry-bg text-gray-800 font-sans antialiased">
    ...
    <!-- WA Toast -->
    <div id="waToast"
        class="fixed top-20 left-1/2 -translate-x-1/2 z-[999] flex items-center gap-2.5 px-4 py-3 bg-green-600 text-white text-sm font-medium rounded-2xl shadow-xl whitespace-nowrap"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center gap-2 sm:gap-3">
                    ...
                    {{-- Desktop --}}
                    <a href="#harga"
                        class="px-4 py-2 rounded-berry text-sm font-medium text-gray-600 hover:text-primary-600 hover:bg-primary-50 transition-colors">Harga
                    </a>
    ...
    <script>
        // Floating WA — sembunyikan saat footer terlihat
    ...
    <script>
        // WA Toast — trigger semua link WA
