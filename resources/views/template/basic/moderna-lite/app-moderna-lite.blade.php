...
<head>
    ...
    <title>Moderna Lite - Essential Series</title>

    <link
        href="https://fonts.googleapis.com/css2?family=Syne:wght@400;700&family=Montserrat:wght@300;400;600&family=Sacramento&family=Amiri&display=swap"
        rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">

    <link rel="stylesheet" href="{{ asset('css/basic/moderna-lite-style.css') }}">
...
<body class="no-scroll">
    ...
    <script>
        ...
        const targetDate = new Date("Aug 08, 2026 09:00:00").getTime();
        setInterval(() => {
